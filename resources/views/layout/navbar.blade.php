<nav class="bg-blue-700 w-full pb-24 relative flex flex-col justify-center px-10 md:px-0 items-center">
    <div class="w-full mb-14 border-b border-blue-600">
        <div class="container mx-auto flex md:flex-row flex-col items-center justify-between py-6">
            ...
            <div class="w-full md:w-auto md:pt-0 pt-3">
                <a href="#" class="w-full md:w-auto justify-center
                 flex space-x-1 items-center border border-blue-600 hover:border-blue-400 transition duration-400 px-5 py-1 rounded text-white font-semibold">
    ...
    <form action="" method="GET" class="w-full max-w-3xl absolute -bottom-8 h-16">
        <input name="search" type="text" class="focus:bg-gray-50 transition duration-200 w-full bg-white h-16 outline-none px-6 shadow md:rounded-xl" placeholder="Search a pokemon by name or id...">
